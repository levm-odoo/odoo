...
class MrpSubcontractingPurchaseTest(TestMrpSubcontractingCommon):
    ...
    def test_automatic_route_selection(self):
        """ Test to verify the automatic selection of product routes:
            ...
            - If product having `bom` type normal, the 'Manufacturing' route is automatically selected.
        ...
        # Make a bom of `component` and verify that 'Manufacturing' route is selected.
        ...
        # Verify that both 'Buy' and 'Resupply Subcontractor on Order' routes are selected.
