...
class ThreadController(http.Controller):
    ...
    @classmethod
    def _get_message_with_access(cls, message_id, operation="read", **kwargs):
        ...
        return request.env['mail.message']._get_with_access(
            ...
            access_params={
                ...
                if key in request.env[message_su.model]._get_allowed_access_params()
            },
        )
    ...
    def _get_thread_with_access(cls, thread_model, thread_id, mode="read", **kwargs):
        ...
        return request.env[thread_model]._get_thread_with_access(
            int(thread_id), mode=mode, access_params={
                key: value for key, value in kwargs.items()
    ...
    def _can_delete_attachment(cls, message, **kwargs):
        return cls._can_edit_message(**kwargs)
