...
class MailThread(models.AbstractModel):
    ...
    def _notify_by_email_prepare_rendering_context(self, message, msg_vals=False,
        ...
        signature = ''
        email_add_signature = msg_vals['email_add_signature'] if 'email_add_signature' in msg_vals else message_sudo.email_add_signature
        if email_add_signature:
            author = message.env['res.partner'].browse(msg_vals['author_id']) if 'author_id' in msg_vals else message_sudo.author_id
