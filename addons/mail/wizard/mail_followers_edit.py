    ...
    def edit_followers(self):
        for wizard in self:
            ...
            if wizard.operation == "remove":
                ...
                # new_partners = wizard.partner_ids - documents.sudo().message_partner_ids
                # if not new_partners:
                #     continue
            ...
            return {
                ...
                "params": {
                    "type": "success",
                    "message": wizard.operation == "add" and self.env._("Followers added") or self.env._("Followers removed"),
                    "sticky": False,
