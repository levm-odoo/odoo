...
class AccountEdiDocument(models.Model):
    ...
    def _process_documents_web_services(self, job_count=None, with_commit=True):
        ...
        for job in jobs_to_process:
            ...
            try:
                documents.exists(for_update=True, nowait=True)
                move_to_lock.exists(for_update=True, nowait=True)
                attachments_potential_unlink.exists(for_update=True, nowait=True)
            except MissingError:
