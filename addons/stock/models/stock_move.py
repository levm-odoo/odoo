...
Please change the quantity done or the rounding precision of your unit of measure.""",
    ...
    def _get_lang(self):
        ...
        return self.picking_id.partner_id.lang or self.partner_id.lang or (self.env.user.id != SUPERUSER_ID and self.env.user.lang) or self.env.context.get('lang') or 'en_US'
