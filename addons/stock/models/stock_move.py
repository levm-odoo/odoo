...
Please change the quantity done or the rounding precision in your settings.""",
    ...
    def _action_done(self, cancel_backorder=False):
        ...
        for result_package in moves_todo\
            ...
            if len(result_package.quant_ids.filtered(lambda q: not float_is_zero(abs(q.quantity) + abs(q.reserved_quantity), precision_digits=precision_digits)).location_id) > 1:
