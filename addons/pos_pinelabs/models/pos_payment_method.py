...
PINELABS_ERROR_CODES_MAPPING = {
    ...
    "INVALID AMOUNT": [14, "The amount provided is invalid."],
    "INVALID MERCHANT": [15, "The merchant ID provided is invalid."],
    "INVALID STORE": [16, "The store ID provided is invalid."],
    "INVALID CLIENT": [17, "The client ID provided is invalid."],
}
