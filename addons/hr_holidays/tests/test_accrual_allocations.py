    ...
    def test_accrual_allocation_without_working_hours(self):
        ...
        with freeze_time("2017-12-5"):
            ...
            try:
                ...
                pass
            if hasattr(error_catcher, 'exception') and error_catcher.exception:
                self.fail("accrual allocation of an employee without working hours should not raise an exception")
