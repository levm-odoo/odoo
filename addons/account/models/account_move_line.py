...
class AccountMoveLine(models.Model):
    ...
    def create(self, vals_list):
        ...
        with moves._check_balanced(move_container),\
             self.env.protector() as protector,\
            ...
            protector.protect([protected for vals, line in zip(vals_list, lines) for protected in self.env['account.move']._get_protected_vals(vals, line)])
    ...
    def write(self, vals):
        ...
        with self.move_id._check_balanced(move_container),\
            ...
            protector.protect(self.env['account.move']._get_protected_vals(vals, self))
