...
class TestTaxesTaxTotalsSummary(TestTaxCommon):
    ...
    def _test_taxes_l10n_pt(self):
            ...
            'subtotals': [
                {
                    ...
                    'tax_groups': [
                        ...
                        {
                            'id': self.tax_groups[3].id,
                            'base_amount_currency': 293.8,
                            'tax_amount_currency': 67.57,
                            'display_base_amount_currency': 293.8,
                        },
                    ],
                },
            ],
        ...
        expected_values = {
            'same_tax_base': True,
            'currency_id': self.currency.id,
            'base_amount_currency': 70.16,
            'tax_amount_currency': 16.14,
            'total_amount_currency': 86.3,
            'subtotals': [
                {
                    'name': "Untaxed Amount",
                    'base_amount_currency': 70.16,
                    ...
                    'tax_groups': [
                        {
                            ...
                            'base_amount_currency': 70.16,
                            'tax_amount_currency': 16.14,
                            'display_base_amount_currency': 70.16,
                        },
                    ],
                },
            ],
        ...
        document = self.populate_document(self.init_document(
            lines=[
                {'quantity': 12.12, 'price_unit': 12.12, 'discount': 8.8, 'tax_ids': tax_13},
                {'quantity': 12.12, 'price_unit': 12.12, 'discount': 8.8, 'tax_ids': tax_13},
        ...
        expected_values = {
            'same_tax_base': False,
            'currency_id': self.currency.id,
            'base_amount_currency': 535.87,
            'tax_amount_currency': 96.46,
            'total_amount_currency': 632.33,
            'subtotals': [
                {
                    'name': "Untaxed Amount",
                    'base_amount_currency': 535.87,
                    ...
                    'tax_groups': [
                        {
                            'id': self.tax_groups[2].id,
                            'base_amount_currency': 267.94,
                            'tax_amount_currency': 34.83,
                            'display_base_amount_currency': 267.94,
                        },
                        {
                            'id': self.tax_groups[3].id,
        ...
        expected_values = {
            'same_tax_base': False,
            'currency_id': self.currency.id,
            'base_amount_currency': 173.4,
            'tax_amount_currency': 22.6,
            'total_amount_currency': 196.0,
            'subtotals': [
                {
                    'name': "Untaxed Amount",
                    'base_amount_currency': 173.4,
                    ...
                    'tax_groups': [
                        {
                            'id': self.tax_groups[2].id,
                            'base_amount_currency': 172.9,
                            'tax_amount_currency': 22.48,
                            'display_base_amount_currency': 172.9,
                        },
                        {
                            'id': self.tax_groups[3].id,
        ...
        expected_values = {
            ...
            'currency_id': self.currency.id,
            'base_amount_currency': 172.9,
            'tax_amount_currency': 22.53,
            'total_amount_currency': 195.43,
            'subtotals': [
                {
                    'name': "Untaxed Amount",
                    'base_amount_currency': 172.9,
                    ...
                    'tax_groups': [
                        {
                            ...
                            'display_base_amount_currency': 172.4,
                        },
                        {
                            'id': self.tax_groups[3].id,
                            'base_amount_currency': 0.5,
    ...
    def _test_intracomm_taxes(self):
    ...
    def test_intracomm_taxes_generic_helpers(self):
        for test_index, document, expected_values in self._test_intracomm_taxes():
            with self.subTest(test_index=test_index):
                self.assert_tax_totals_summary(document, expected_values)
        self._run_js_tests()

    def test_intracomm_taxes_invoices(self):
        for test_index, document, expected_values in self._test_intracomm_taxes():
            with self.subTest(test_index=test_index):
                invoice = self.convert_document_to_invoice(document)
                self.assert_invoice_tax_totals_summary(invoice, expected_values)
