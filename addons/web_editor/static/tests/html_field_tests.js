...
QUnit.module("WebEditor.HtmlField", ({ beforeEach }) => {
    ...
    // testing if it is possible to paste an image in the editor when preventPastingFiles is set to false
    QUnit.test("Paste image in the editor", async (assert) => {
        ...
        await makeView({
            ...
            arch: `
                <form>
                    <field name="txt" widget="html" options="{'preventPastingFiles': true}"/>
                </form>`,
        });
