...
QUnit.module('convert_inline', {}, function () {
    ...
    QUnit.test('Correct border attributes for outlook', async function (assert) {
        ...
        convertInline.classToStyle($editable, convertInline.getCSSRules($editable[0].ownerDocument));
        assert.strictEqual($editable.html(),
            `<div class=\"test-border-zero\" style=\"border-style:none;box-sizing:border-box;border-width:0px;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px\"></div>`,
        ...
        convertInline.classToStyle($editable, convertInline.getCSSRules($editable[0].ownerDocument));
        assert.strictEqual($editable.html(),
            `<div class=\"test-border-one\" style=\"border-style:solid;box-sizing:border-box;border-width:1px;border-bottom-width:1px;border-left-width:1px;border-right-width:1px;border-top-width:1px\"></div>`,
