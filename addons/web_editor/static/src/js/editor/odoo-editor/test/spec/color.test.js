...
describe('applyColor', () => {
    ...
    it("should apply text color whithout interrupting gradient text color on selected text", async () => {
        await testEditor(BasicEditor, {
            contentBefore: '<p><font class="text-gradient" class="text-gradient" style="background-image: linear-gradient(135deg, rgb(214, 255, 127) 0%, rgb(0, 179, 204) 100%);">ab[ca]bc</font></p>',
            stepFunction: setColor("rgb(255, 0, 0)", "color"),
    ...
    it("should break gradient color on selected text", async () => {
        await testEditor(BasicEditor, {
            contentBefore: '<p><font class="text-gradient" class="text-gradient" style="background-image: linear-gradient(135deg, rgb(214, 255, 127) 0%, rgb(0, 179, 204) 100%);">ab[ca]bc</font></p>',
            stepFunction: setColor("linear-gradient(135deg, rgb(255, 174, 127) 0%, rgb(109, 204, 0) 100%)", "background-image"),
