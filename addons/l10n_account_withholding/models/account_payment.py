...
class AccountPayment(models.Model):
    ...
    l10n_account_wth_line_ids = fields.One2many(
        ...
        compute='_l10n_account_wth_compute_withholding_line_ids',
        readonly=True
    )
    ...
    def _l10n_account_wth_compute_withholding_line_ids(self):
        for payment in self:
            payment.l10n_account_wth_line_ids = payment.move_id.line_ids.filtered(lambda p: p.tax_line_id.l10n_account_wth_is_wth_tax)
    ...
    def write(self, vals):
        ...
        if significant_changes and self.l10n_account_wth_line_ids:
