...
class WebsiteSale(payment_portal.PaymentPortal):
    ...
    def portal_address(self, partner_id=None, address_type='billing', template_to_render='portal.portal_my_details', **query_params):
        ...
        return super().portal_address(
            partner_id=partner_id, address_type=address_type, order_sudo=order_sudo, template_to_render=address_template, **query_params
        )
    ...
    def _prepare_address_form_values(
        ...
        :rtype: dict
        """
        val = super()._prepare_address_form_values(partner_sudo, address_type, use_same, callback, **_kwargs)
    ...
    def shop_address_submit(
        self, partner_id=None, address_type='billing', use_same=None, callback=None,
        ...
        if address_type == 'billing':
            ...
            if is_anonymous_cart and not order_sudo.only_services and not use_same:
                ...
                callback = callback or '/portal/address?address_type=delivery'
