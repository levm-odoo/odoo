...
class ResCompany(models.Model):
    ...
    l10n_in_edi_token = fields.Char(
        ...
        compute="_compute_edi_token_and_edi_token_validity",
        store=True,
    )
    ...
    @api.depends('vat', 'l10n_in_edi_username', 'l10n_in_edi_password')
    def _compute_edi_token_and_edi_token_validity(self):
        ...
        filtered_set.l10n_in_edi_token = False
        filtered_set.l10n_in_edi_token_validity = False
