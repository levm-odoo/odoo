...
class CrmTeam(models.Model):
    ...
    def _assign_and_convert_leads(self, force_quota=False):
        ...
        for team, leads_to_assign_ids in leads_per_team.items():
            ...
            members_to_assign_with_preferred_domain = [m for m in members_to_assign if m.assignment_preferred_domain and literal_eval(m.assignment_preferred_domain)]
            ...
            _logger.info('%s preferred leads have not been assigned to preference because of quota on a total of %s leads with preference for team %s', total_preffered_count - total_assigned_preffered_count, total_preffered_count, team.name)
