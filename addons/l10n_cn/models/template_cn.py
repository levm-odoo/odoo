...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _get_cn_template_data(self):
        return {
            ...
            'parent': 'cn_common',
            'property_account_expense_categ_id': 'l10n_cn_common_account_5401',
            'property_account_income_categ_id': 'l10n_cn_common_account_5001',
            'property_stock_account_input_categ_id': 'l10n_cn_common_account_140201',
            'property_stock_account_output_categ_id': 'l10n_cn_common_account_140202',
        }
    ...
    def _get_cn_res_company(self):
        return {
            self.env.company.id: {
                ...
                'account_production_wip_account_id': 'l10n_cn_common_account_1406',
                ...
                'account_production_wip_overhead_account_id': 'l10n_cn_common_account_140601',
