...
class TestPricelist(ProductCommon):
    ...
    def test_10_discount(self):
        ...
        self.assertAlmostEqual(
            ...
            self.sale_pricelist_id._get_product_price(self.usb_adapter, 1.0, uom=self.uom_pack_of_6))
        ...
        self.assertAlmostEqual(
            ...
            self.sale_pricelist_id._get_product_price(self.datacard, 1.0, uom=self.uom_pack_of_6))
