...
class PosConfig(models.Model):
    ...
    receipt_bg = fields.Selection([('Blank', 'Blank'), ('Demo logo', 'Demo logo'), ('Custom', 'Custom')], default="Blank", string='Background Layout', required=True)
    receipt_bg_image = fields.Binary(string='Receipt Background Image', help="A logo that will be printed in the receipt.")
    receipt_layout = fields.Selection([('light', 'Light'), ('boxes', 'Boxes'), ('lined', 'Lined')], string="Receipt Layout", default='light', required=True)
