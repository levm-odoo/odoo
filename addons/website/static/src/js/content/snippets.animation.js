...
publicWidget.registry.CarouselSingleScrollMode = publicWidget.Widget.extend({
    ...
    start() {
        ...
        this.isCycleEnable = this.el.dataset.bsWrap;
        this.itemsPerSlide = parseInt(this.el.dataset.itemsPerSlide) || 4;
        // Preload 8 images in both directions.
        this._loadPrevItemsImages(8);
        this._loadNextItemsImages(8);
     ...
     * @private
     */
    _loadPrevItemsImages(nItemsToLoad = 1) {
        ...
        this._loadItemImages(prevItemsToLoad.reverse());
    },
    /**
     ...
     * @private
     */
    _loadNextItemsImages(nItemsToLoad = 1) {
        ...
        this._loadItemImages(nextItemsToLoad);
    },
    /**
