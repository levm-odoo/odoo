...
class HrLeaveType(models.Model):
    ...
    is_limited_to_optional_days = fields.Boolean(
        help="""Enable this option to restrict Flexi Leave to specific days, ensuring that only days marked as Optional Holidays
        can be selected. This helps validate that employees can only choose days from the designated Optional Holiday list
        for their Flexi Leave.""")
