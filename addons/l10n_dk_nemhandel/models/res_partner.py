...
class ResPartner(models.Model):
    ...
    def _compute_nemhandel_identifier_value(self):
        for partner in self:
            ...
            country_code = partner._deduce_country_code()
            if country_code != 'DK' or partner.nemhandel_identifier_type != '0184':
    ...
    def _compute_is_using_nemhandel(self):
        ...
        for partner in self:
            if partner.ubl_cii_format == 'oioubl_21' and nemhandel_user:
                partner.is_using_nemhandel = True
            else:
                partner.is_using_nemhandel = False
