...
class TestPaymentTransaction(NuveiCommon):
    ...
    def _get_expected_values(self, tx):
        ...
        phone_number = tx.partner_phone and tx._phone_format(
            number=tx.partner_phone, country=tx.partner_country_id, raise_exception=False
        )
    ...
    def test_processing_values_contain_rounded_amount_usd_webpay(self):
        ...
        contain amount which is the amount rounded down to the nearest 0."""
