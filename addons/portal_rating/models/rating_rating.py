...
class RatingRating(models.Model):
    ...
    def _to_store_defaults(self):
        return super()._to_store_defaults() + [
            Store.Attr("publisher_comment", predicate=lambda rating: rating.publisher_comment),
            Store.Attr("publisher_datetime", predicate=lambda rating: rating.publisher_datetime),
            Store.One(
                "publisher_id",
