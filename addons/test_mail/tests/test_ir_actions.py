...
class TestServerActionsEmail(MailCommon, TestServerActionsBase):
    ...
    def test_action_followers_warning(self):
        ...
        self.assertEqual(self.action.warning_msg, "The field 'Salesperson > Name' is not a partner field.")
        self.action.write({"followers_partner_field_name": "parent_id.child_ids"})
        self.assertEqual(self.action.warning_msg, False)
    ...
    def test_action_next_activity_warning(self):
        ...
        self.assertEqual(self.action.warning_msg, "The field 'Salesperson > Name' is not a user field.")
