...
describe("wrapInlinesInBlocks", () => {
    ...
    test("wrap block with display style inline in div", async () => {
        ...
        // element. It is debatable whether an empty paragraph-related element
        ...
        // todo baseContainer => convert empty paragraphRelatedComponent to
        // unbreakable div when inserting a flow inline ?
