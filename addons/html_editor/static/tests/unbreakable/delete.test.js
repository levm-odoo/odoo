    ...
    describe("selection collapsed", () => {
        test("should not outdent while nested within a list item if the list is unbreakable", async () => {
            ...
            await testEditor({
                ...
                stepFunction: deleteBackward,
                contentAfter:
                    '<ol class="oe_unbreakable"><li><div><div class="o-paragraph">[]abc</div></div></li><li>def</li></ol>',
            });
            // In the middle.
            await testEditor({
                contentBefore:
                ...
                stepFunction: deleteBackward,
                contentAfter:
                    '<ol class="oe_unbreakable"><li><div class="o-paragraph">abc</div></li><li><div><div class="o-paragraph">[]def</div></div></li><li>ghi</li></ol>',
            });
            // Last LI.
            await testEditor({
                contentBefore:
                ...
                stepFunction: deleteBackward,
                contentAfter:
                    '<ol class="oe_unbreakable"><li>abc</li><li><div><div class="o-paragraph">[]def</div></div></li></ol>',
            });
            ...
            await testEditor({
                ...
                stepFunction: deleteBackward,
                contentAfter:
                    '<div class="o-paragraph">abc</div><ol class="oe_unbreakable"><li>def</li><li><div><div class="o-paragraph">[]ghi</div></div></li><li>jkl</li></ol>',
            });
        });
