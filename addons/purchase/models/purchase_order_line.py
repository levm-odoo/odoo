    ...
    def _compute_price_unit_and_date_planned_and_name(self):
        for line in self:
            ...
            if not seller:
                ...
                price_unit = line.env['account.tax']._fix_tax_included_price_company(seller.price, line.product_id.supplier_tax_ids, line.taxes_id, line.company_id) if seller else 0.0
