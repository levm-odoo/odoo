...
class ProductTemplate(models.Model):
    ...
    def _compute_sales_count(self):
        ...
        for product in self:
            product.sales_count = float_round(sum(p.sales_count for p in product.with_context(active_test=False).product_variant_ids), precision_digits=precision_digits)
