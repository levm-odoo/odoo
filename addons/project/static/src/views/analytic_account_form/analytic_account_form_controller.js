...
export class AnalyticAccountFormController extends FormController {
    ...
    async saveButtonClicked(params = {}) {
        ...
        const projectsName = await this.orm.call("project.project", "get_projects_name_from_account", [this.props.resId, this.model.root._changes['plan_id']]);
        if (!projectsName){
            return super.saveButtonClicked(params);
        }
        ...
        this.dialogService.add(ConfirmationDialog, {
            ...
            confirm: async () => {
                await this.orm.call("project.project", "remove_accounts_from_projects", [[this.props.resId]]);
