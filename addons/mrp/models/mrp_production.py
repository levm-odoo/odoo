...
class MrpProduction(models.Model):
    ...
    log_note = fields.Html(string="Additional Notes", compute='_compute_log_note', store=True, help="Add this note on the manufacturing order to share any additional information")
