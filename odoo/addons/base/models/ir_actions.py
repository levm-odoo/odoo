...
# To return an action, assign: action = {...}\n\n\n\n"""
    ...
    child_ids = fields.One2many('ir.actions.server', 'parent_id', copy=True, domain=lambda self: f"[{', '.join(self._get_linkable_childs_domain_parts())}]",
    ...
    def _get_linkable_childs_domain_parts(self):
        return [
            "('model_id', '=', model_id)",
            "('parent_id', '=', False)",
            "('id', '!=', id)",
