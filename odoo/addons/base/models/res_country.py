...
class ResCountry(models.Model):
    ...
    def _compute_country_group_codes(self):
        for country in self:
            country_group_codes = [
                # Check if there is no False value
                country_group.code
                for country_group in country.country_group_ids
                if country_group.code
            ]
            country.country_group_codes = ",".join(country_group_codes)
