...
class IrProfile(models.Model):
    ...
    def _compute_speedscope(self):
        ...
        params = {
            ...
            'combined_profile' : request.httprequest.args.get('combined_profile','False')=='True',
            'combined_no_context_profile' : request.httprequest.args.get('combined_no_context_profile','False')=='True',
            'sql_no_gap_profile' : request.httprequest.args.get('sql_no_gap_profile','False')=='True',
            'sql_density_profile' : request.httprequest.args.get('sql_density_profile','False')=='True',
            'frames_profile' : request.httprequest.args.get('frames_profile','False')=='True',
        }
