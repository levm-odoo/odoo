...
class TestUsers2(UsersCommonCase):
    ...
    def test_implied_groups_on_change(self):
        ...
        user_form['view_group_type_user'] = group_portal.id
        ...
        user_form['view_group_type_user'] = group_public.id
        self.assertTrue(user_form.share, 'The group_ids onchange should have been triggered')

        with self.assertRaises(AssertionError):
            user_form['view_group_selection_ids'] = [Command.link(group_contain_user.id)]
        with self.assertRaises(AssertionError):
            user_form['view_group_extra_ids'] = [Command.link(group_contain_user.id)]
        ...
        with self.debug_mode():
            ...
            user_form['view_group_extra_ids'] = group_contain_user
            self.assertFalse(user_form.share, 'The group_ids onchange should have been triggered')
