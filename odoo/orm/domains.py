...
def _optimize_merge_many2one_any(cls, model, conditions):
    ...
    return [DomainCondition(field_expr, 'any', cls(sub_domains))._optimize(model), *other_conditions]
...
def _optimize_merge_many2one_not_any(cls, model, conditions):
    ...
    return [DomainCondition(field_expr, 'not any', cls(sub_domains))._optimize(model), *other_conditions]
