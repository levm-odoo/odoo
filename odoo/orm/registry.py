...
class Registry(Mapping[str, type["BaseModel"]]):
    ...
    @classmethod
    @locked
    def new(cls, db_name: str, force_demo: bool = False, status: None = None, update_module: bool = False, init: Iterable = (), update: Iterable = (), demo: Iterable = ()) -> Registry:
        ...
        try:
            ...
            try:
                load_modules(registry, force_demo, update_module=update_module, init=init, update=update, demo=demo)
            except Exception:
