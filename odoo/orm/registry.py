...
class Registry(Mapping[str, type["BaseModel"]]):
    ...
    _constraints_validated: bool  # whether there was no errors during validation of constraints
    ...
    @property
    def constraints_validated(self) -> bool:
        """We can rely on the constraints when they are valid and the registry is ready."""
        return self.ready and self._constraints_validated
